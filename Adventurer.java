public class Adventurer{
    ...
    private int dexterity;			//CHANGES HAVE BEEN MADE
    ...
    private int sight;
		public Adventurer(String name){
			...
			this.level = level;
			this.hp = determineHP(attributeMods);
			this.age = determineAge(race);
			determineHeight();
			determineSpeed();
			determineSight();
		...
		public int determineAge(String raceAge){
			int age = 0;
